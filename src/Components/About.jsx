  ...
  return (
    <>
      <div id="about" className="scroll-top">
        <SectionTitle text1={"A"} text2={"About Us"} />
      </div>
      <div id="about" className="aboutContainer">
        <div className="aboutTitle">
          <span></span>
          <h1>
            Driving Business Growth Through Intelligent Investment and Strategic
            Leadership
          </h1>
        </div>
        ...
        <div className="aboutContent">
          ...
          <div className="rightSide">
            <p>
              <span>Link World FZCO</span> is a Dubai-based holding company that
              strategically manages a diverse portfolio of subsidiary companies
              across various industries. With a focus on sustainable growth and
              global expansion, Link World FZCO provides financial, strategic,
              and operational support to its subsidiaries, ensuring long-term
              success.
            </p>
            <img
              src="https://cdn.pixabay.com/photo/2017/05/02/03/41/action-2277292_1280.jpg"
        ...
        {visionMissionData.map((section, index) => (
          <div
            className={`vision-mission-container ${section.reverse}`}
            key={index}
          >
            <div className="leftSide">
      ...
      <div className="strategy-section">
        ...
        <div className="card-row">
          <div className="quote-card">
            <span className="quote-icon open">
              <BiSolidQuoteAltLeft />
            </span>
            <p>{data[0]}</p>
            <span className="quote-icon close">
